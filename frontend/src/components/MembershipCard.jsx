...
export default function MembershipCard({ member }) {
  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-gradient-to-br from-slate-900 via-slate-950 to-indigo-950 border border-slate-800/80 rounded-2xl p-6 shadow-2xl text-white relative overflow-hidden">
