  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 bg-slate-900/80 border border-slate-800 rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden backdrop-blur-xl">
          <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-4">
            <div>
              <span className="text-xs font-mono uppercase tracking-widest text-indigo-400 font-bold block">
                Biomechanical Map
              </span>
              <h2 className="text-lg font-black uppercase text-white">Interactive Muscle Selector</h2>
            </div>
            ...
            <div className="flex bg-slate-950 border border-slate-800 p-1 rounded-2xl">
              <button
                ...
                className={`px-3 py-1.5 text-xs font-bold rounded-xl transition ${
                  bodyView === 'front' ? 'bg-indigo-600 text-white shadow-lg' : 'text-slate-400 hover:text-white'
                }`}
              >
                Front
              </button>
              <button
                ...
                className={`px-3 py-1.5 text-xs font-bold rounded-xl transition ${
                  bodyView === 'back' ? 'bg-indigo-600 text-white shadow-lg' : 'text-slate-400 hover:text-white'
                }`}
              >
                Back
              </button>
          ...
          {/* SVG ANATOMY MAP CONTAINER */}
          <div className="relative flex-1 min-h-[340px] flex items-center justify-center p-4">
            <svg 
              viewBox="0 0 240 380" 
              className="w-full h-full max-h-[350px] drop-shadow-2xl select-none"
            >
              ...
              {/* Head */}
              <ellipse cx="120" cy="35" rx="18" ry="22" fill="#334155" />
              {/* Neck */}
              <rect x="112" y="55" width="16" height="15" fill="#1e293b" />

              {bodyView === 'front' ? (
                <>
                  {/* SHOULDERS / DELTS */}
                  <path
                    d="M 85 70 C 72 75, 68 95, 78 112 C 86 100, 92 88, 98 75 Z"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'shoulders' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                  ...
                  />
                  <path
                    d="M 155 70 C 168 75, 172 95, 162 112 C 154 100, 148 88, 142 75 Z"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'shoulders' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('shoulders')}
                  ...
                  {/* CHEST / PECTORALS */}
                  <path
                    d="M 98 75 C 105 72, 118 72, 120 78 C 120 108, 96 112, 92 110 C 88 100, 92 85, 98 75 Z"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'chest' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-600 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('chest')}
                    onMouseEnter={() => setHoveredMuscle('Chest (Pectoralis Major)')}
                    onMouseLeave={() => setHoveredMuscle(null)}
                  />
                  <path
                    d="M 142 75 C 135 72, 122 72, 120 78 C 120 108, 144 112, 148 110 C 152 100, 148 85, 142 75 Z"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'chest' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-600 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('chest')}
                  ...
                  {/* BICEPS */}
                  <rect
                    x="68" y="112" width="14" height="30" rx="7"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'biceps' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                  ...
                  />
                  <rect
                    x="158" y="112" width="14" height="30" rx="7"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'biceps' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('biceps')}
                  ...
                  {/* FOREARMS */}
                  <rect x="58" y="145" width="12" height="42" rx="5" fill="#334155" />
                  <rect x="170" y="145" width="12" height="42" rx="5" fill="#334155" />

                  {/* CORE / ABS */}
                  <g
                    className="cursor-pointer"
                    onClick={() => handleMuscleClick('core')}
                    onMouseEnter={() => setHoveredMuscle('Abdominals & Core')}
                    onMouseLeave={() => setHoveredMuscle(null)}
                  >
                    <rect
                      x="105" y="115" width="30" height="60" rx="6"
                      className={`transition duration-200 ${
                        selectedMuscle === 'core' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                      }`}
                    />
                    {/* Six pack divider lines */}
                    <line x1="120" y1="115" x2="120" y2="175" stroke="#0f172a" strokeWidth="2" />
                    <line x1="105" y1="135" x2="135" y2="135" stroke="#0f172a" strokeWidth="2" />
                    <line x1="105" y1="155" x2="135" y2="155" stroke="#0f172a" strokeWidth="2" />
                  </g>

                  {/* QUADS */}
                  <path
                    d="M 94 185 C 92 210, 90 245, 96 260 C 104 260, 112 250, 114 185 Z"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'quads' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                  ...
                  />
                  <path
                    d="M 146 185 C 148 210, 150 245, 144 260 C 136 260, 128 250, 126 185 Z"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'quads' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('quads')}
                  ...
                  {/* CALVES & SHINS */}
                  <rect x="94" y="275" width="16" height="60" rx="8" fill="#334155" />
                  <rect x="130" y="275" width="16" height="60" rx="8" fill="#334155" />
                </>
              ) : (
                <>
                  {/* BACK VIEW */}
                  {/* TRAPS / UPPER BACK */}
                  <path
                    d="M 100 60 L 140 60 L 155 85 L 120 115 L 85 85 Z"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'back' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-600 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('back')}
                    onMouseEnter={() => setHoveredMuscle('Upper Back & Trapezius')}
                    onMouseLeave={() => setHoveredMuscle(null)}
                  />

                  {/* LATS */}
                  <path
                    d="M 85 85 L 120 115 L 155 85 L 145 155 L 95 155 Z"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'back' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('back')}
                    onMouseEnter={() => setHoveredMuscle('Latissimus Dorsi (Lats)')}
                    onMouseLeave={() => setHoveredMuscle(null)}
                  />

                  {/* TRICEPS */}
                  <rect
                    x="66" y="105" width="14" height="36" rx="7"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'triceps' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                  ...
                  />
                  <rect
                    x="160" y="105" width="14" height="36" rx="7"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'triceps' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('triceps')}
                  ...
                  {/* GLUTES */}
                  <ellipse
                    cx="106" cy="188" rx="16" ry="18"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'glutes' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-600 hover:fill-indigo-400/80'
                    }`}
                  ...
                  {/* HAMSTRINGS */}
                  <rect
                    x="94" y="210" width="18" height="52" rx="8"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'hamstrings' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                  ...
                  />
                  <rect
                    x="128" y="210" width="18" height="52" rx="8"
                    className={`cursor-pointer transition duration-200 ${
                      selectedMuscle === 'hamstrings' ? 'fill-indigo-500 filter-[url(#activeGlow)]' : 'fill-slate-700 hover:fill-indigo-400/80'
                    }`}
                    onClick={() => handleMuscleClick('hamstrings')}
                  ...
                  <rect x="94" y="275" width="16" height="55" rx="8" fill="#334155" />
                  <rect x="130" y="275" width="16" height="55" rx="8" fill="#334155" />
                </>
              )}
            </svg>

            {/* HOVER TOOLTIP */}
            <div className="absolute bottom-2 left-1/2 -translate-x-1/2 bg-slate-950/90 border border-slate-700/80 px-4 py-1.5 rounded-full text-xs font-mono text-indigo-300 shadow-xl pointer-events-none">
              {hoveredMuscle || (selectedMuscle !== 'all' ? `Filtered: ${selectedMuscle.toUpperCase()}` : 'Click any muscle to filter')}
            </div>
          </div>

          <div className="flex items-center justify-between text-xs text-slate-400 pt-3 border-t border-slate-800">
            <span>Selected Filter: <strong className="text-white uppercase">{selectedMuscle}</strong></span>
            {selectedMuscle !== 'all' && (
              <button
                type="button"
